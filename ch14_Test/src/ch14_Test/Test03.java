...
//  JDBC에서 Statement/PreparedStatement/CallableStatement 각각의  객체를 설명하고, 비교하시요  
public class Test03 {
...
//   이 out 매개변수는 registerOutParameter(물음표 순서, 데이터베이스의 데이터 타입); 메소드를 통해 
//		Java에서 그 값을 이용할 수 있다.
	}
